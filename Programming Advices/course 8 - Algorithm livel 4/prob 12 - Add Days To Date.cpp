...
sDate AddDaysToDate(int AddDays, sDate Date)
{
    short RemainingDays = AddDays + NumberOfDaysFromTheBeginigOfYear(Date.Year, Date.Month, Date.Day);
    short MonthDays = 0;
